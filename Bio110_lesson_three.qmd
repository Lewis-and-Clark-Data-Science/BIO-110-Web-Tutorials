...
See [the home page](index.qmd) for more details on how to use this tutorial and for troubleshooting tips!
...
-   [Arguments](Bio110_lesson_two.qmd#sec-arguments) used:
...
Now, let's save this data as a new variable. Recall you can use `<-` to [assign data](Bio110_lesson_one.qmd#sec-assign-variable) to a new variable. Try creating a new variable that includes all the rows for which the `Condition` is equal to "1". Call your new variable `exerciseData`. 
