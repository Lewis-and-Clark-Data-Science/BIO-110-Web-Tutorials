...
-   There are **interactive code editors** throughout the tutorials. Sometimes, there is an option to see a hint, check your work or see the answer. You are encouraged to try writing the code yourself before looking at a hint or the answer. You can also click the "Check your work" button if you want a way to see if you did it right without giving away the answer.
