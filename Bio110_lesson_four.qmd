...
Let's look at an example to see how this works. We'll start by creating a histogram. Try running the code below. 
...
This will create a histogram of the heart rate values. 

Note how the code is set up: 
