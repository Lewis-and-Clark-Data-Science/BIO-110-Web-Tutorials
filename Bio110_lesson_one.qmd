...
The rest of this tutorial will teach you how to work with data in R. It is interactive, so you'll be able to write your own code in code chunks like the one above throughout the tutorial. See [the home page](index.qmd) for more details on using the tutorials and for troubleshooting tips!
