...
When creating a boxplot, our x variable should be **categorical**, and our y variable is **continuous**. 
...
Boxplots are an excellent graphing option for many datasets, because they are valid regardless of whether or not the data are normally distributed. But they take a little getting used to, because they are not as commonly seen as histogram or bar graphs are.
